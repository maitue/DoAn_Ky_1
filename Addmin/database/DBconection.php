<?php 
    ...
    */
    class Database
    {
        ...
        {
            $this->link = mysqli_connect("localhost","root","","csdl") or die ();
            mysqli_set_charset($this->link,"utf8");
        }
            // mysqli_set_charset chuyển dang tiếng việt
         ...
         */
        public function delete ($table ,  $id )//xóa theo id
        {
        ...
        public function fetchID($table , $id )//lấy san pham có id bằng id chuyền vào
        {
