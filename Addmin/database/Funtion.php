<?php 
		...
		{	
			//neu ton tai string th return post string nguoc  lai return gia tri trong
		...
		*/
		...
		function base_url(){
				return $url = "http://localhost/DoAn/Addmin/";
			}
            function base1_url(){
		...
		if (! function_exists('redirectAdmin')) {
			...
			{
				header("location: ".base_url()."modul/{$url}");exit();
			}
